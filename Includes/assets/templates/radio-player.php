...
<?php if (!$stream): ?>
    <div class="lkp-warning">
        <strong>Warning:</strong> No radio stream found. Please select a radio from the list.
    </div>
<?php else: ?>

<script>
    // Variáveis globais para o visualizador simples
    ...
    // Dados da estação para exibição junto com a música
...
<div class="lkp-player-wrapper">
    <div id="lknwp-radio-custom-player" class="lkp-player-container">
        ...
        <div id="lknwp-radio-img-parent" class="lkp-img-parent">
            <img src="<?php echo esc_attr($station_img); ?>" alt="Radio logo" class="lkp-station-img" onerror="this.onerror=null;this.src='<?php echo esc_js($default_img_url); ?>';">
        </div>
        <div id="lknwp-radio-station-name" class="lkp-station-name">
            <?php echo $station_name ? esc_html($station_name) : 'Online Radio'; ?>
        </div>
    </div>
    ...
    <div id="lknwp-radio-play-section" class="lkp-play-section">
        ...
        <div class="lkp-share-section">
            ...
            <button id="lknwp-share-copy" class="lkp-share-btn" title="Copiar link">
            ...
            <!-- Instagram -->
            <a id="lknwp-share-instagram" class="lkp-share-btn" title="Compartilhar no Instagram">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- WhatsApp -->
            <a id="lknwp-share-whatsapp" class="lkp-share-btn" title="Compartilhar no WhatsApp">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Twitter -->
            <a id="lknwp-share-twitter" class="lkp-share-btn" title="Compartilhar no Twitter">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div id="lknwp-radio-current-song-block" class="lkp-current-song-block">
        ...
        <div class="lkp-song-info">
            ...
            <div id="lknwp-radio-current-song" class="lkp-current-song">Carregando...</div>
    ...
    <div class="lkp-volume-section">
        <label for="lknwp-radio-volume" class="lkp-volume-label">Volume</label>
